...
from api.application.use_cases import UpdateMenuUseCase
from api.application.use_cases.update_new_menu import MenuInputDto, MenuMakeOutputDto, MenuDescripcionDTO
...
@pytest.fixture()
def descripcion_menu_dto(exemplary_menu_id: str,descripcion: str, entrada: str, ensalada: str, plato_fondo: str, postre: str, status_id: int, fecha_menu: str) -> MenuDescripcionDTO:
    return [MenuDescripcionDTO(exemplary_menu_id, descripcion, entrada, ensalada, plato_fondo, postre, status_id, fecha_menu)]
...
def test_loads_user_using_id_found(
    ...
    UpdateMenuUseCase().execute(input_dto)
